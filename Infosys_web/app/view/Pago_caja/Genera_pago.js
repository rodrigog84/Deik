Ext.define('Infosys_web.view.Pago_caja.Genera_pago', {
    extend: 'Ext.window.Window',
    alias : 'widget.generapagoingresar',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        items: [{
                            ...
                            labelAlign: 'top',
                            renderer: function(valor){return Ext.util.Format.number((neto),"0,000")}
                        },{
                            xtype: 'numberfield',
                            fieldCls: 'required',
                            width: 200,
                        ...
                        {xtype: 'splitter'},
                        {
                            ...
                            labelAlign: 'top',
                            renderer: function(valor){return Ext.util.Format.number((valor),"0.000")}
                        },{
                            xtype: 'numberfield',
                            width: 200,
                            value: 0,
                        ...
                        {xtype: 'splitter'},
                        {
                            ...
                            labelAlign: 'top',
                            renderer: function(valor){return Ext.util.Format.number((afecto),"0.000")}
                        },{
                            xtype: 'numberfield',
                            fieldCls: 'required',
                            width: 200,
