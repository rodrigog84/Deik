Ext.define('Infosys_web.view.cotizaciones.Ingresar', {
    extend: 'Ext.window.Window',
    alias : 'widget.cotizacioningresar',
    ...
    initComponent: function() {
        ...
        var stItms = Ext.getStore('cotizacion.Items');
        stItms.load();
